...
export class Cvss3P0Components {
    ...
    private static readonly TEMPLATE_CIA_REQUIREMENT_MODIFIED = [
        Cvss3P0Components.TEMPLATE_CIA_REQUIREMENT_MODIFIED_VALUES.X,
        Cvss3P0Components.TEMPLATE_CIA_REQUIREMENT_MODIFIED_VALUES.L,
        Cvss3P0Components.TEMPLATE_CIA_REQUIREMENT_MODIFIED_VALUES.M,
        Cvss3P0Components.TEMPLATE_CIA_REQUIREMENT_MODIFIED_VALUES.H
    ] as NumberVectorComponentValue[];
    ...
    public static readonly AV = {
        ...
        values: [
            Cvss3P0Components.AV_VALUES.X,
            Cvss3P0Components.AV_VALUES.N,
            Cvss3P0Components.AV_VALUES.A,
            Cvss3P0Components.AV_VALUES.L,
            Cvss3P0Components.AV_VALUES.P
        ] as NumberVectorComponentValue[]
    };
    ...
    public static readonly AC = {
        ...
        values: [
            Cvss3P0Components.AC_VALUES.X,
            Cvss3P0Components.AC_VALUES.L,
            Cvss3P0Components.AC_VALUES.H
        ] as NumberVectorComponentValue[]
    };
    ...
    public static readonly PR = {
        ...
        values: [
            Cvss3P0Components.PR_VALUES.X,
            Cvss3P0Components.PR_VALUES.N,
            Cvss3P0Components.PR_VALUES.L,
            Cvss3P0Components.PR_VALUES.H
    ...
    public static readonly UI = {
        ...
        values: [
            Cvss3P0Components.UI_VALUES.X,
            Cvss3P0Components.UI_VALUES.N,
            Cvss3P0Components.UI_VALUES.R
        ] as NumberVectorComponentValue[]
    };
    ...
    public static readonly S = {
        ...
        values: [
            Cvss3P0Components.S_VALUES.X,
            Cvss3P0Components.S_VALUES.U,
            Cvss3P0Components.S_VALUES.C
    ...
    public static readonly MAV = {
        ...
        values: [
            Cvss3P0Components.MAV_VALUES.X,
            Cvss3P0Components.MAV_VALUES.N,
            Cvss3P0Components.MAV_VALUES.A,
            Cvss3P0Components.MAV_VALUES.L,
            Cvss3P0Components.MAV_VALUES.P
        ] as NumberVectorComponentValue[]
    };
    ...
    public static readonly MAC = {
        ...
        values: [
            Cvss3P0Components.MAC_VALUES.X,
            Cvss3P0Components.MAC_VALUES.L,
            Cvss3P0Components.MAC_VALUES.H
        ] as NumberVectorComponentValue[]
    };
    ...
    public static readonly MPR = {
        ...
        values: [
            Cvss3P0Components.MPR_VALUES.X,
            Cvss3P0Components.MPR_VALUES.N,
            Cvss3P0Components.MPR_VALUES.L,
            Cvss3P0Components.MPR_VALUES.H
        ] as ChangedNumberVectorComponentValue[]
    };
    ...
    public static readonly MUI = {
        ...
        values: [
            Cvss3P0Components.MUI_VALUES.X,
            Cvss3P0Components.MUI_VALUES.N,
            Cvss3P0Components.MUI_VALUES.R
        ] as NumberVectorComponentValue[]
    };
    ...
    public static readonly MS = {
        ...
        values: [
            Cvss3P0Components.MS_VALUES.X,
            Cvss3P0Components.MS_VALUES.U,
            Cvss3P0Components.MS_VALUES.C
        ] as BooleanVectorComponentValue[]
    };
